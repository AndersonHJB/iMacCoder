<audio title="07 _ constvolatilemutable：常量变量究竟是怎么回事？" src="https://static001.geekbang.org/resource/audio/13/2a/130847d342028d4dcd2277aede0cf42a.mp3" controls="controls"></audio> 
<p>你好，我是Chrono。</p><p>上节课我讲了自动类型推导，提到auto推导出的类型可以附加const、volatile修饰（通常合称为“cv修饰符”）。别看就这么两个关键字，里面的“门道”其实挺多的，用好了可以让你的代码更安全、运行得更快。今天我就来说说它们俩，以及比较少见的另一个关键字mutable。</p><h2>const与volatile</h2><p>先来看<strong>const</strong>吧，你一定对它很熟悉了。正如它的字面含义，表示“常量”。最简单的用法就是，<strong>定义程序用到的数字、字符串常量，代替宏定义</strong>。</p><pre><code>const int MAX_LEN       = 1024;
