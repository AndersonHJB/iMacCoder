<audio title="05 _ for (let x of [1,2,3]) ...：for循环并不比使用函数递归节省开销" src="https://static001.geekbang.org/resource/audio/45/fe/454307d34b873ef16a9f3a78bafaccfe.mp3" controls="controls"></audio> 
