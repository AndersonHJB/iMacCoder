<audio title="43 _ PCA主成分分析（下）：为什么要计算协方差矩阵的特征值和特征向量？" src="https://static001.geekbang.org/resource/audio/e7/5f/e7263c041cac42252155130600a99d5f.mp3" controls="controls"></audio> 
