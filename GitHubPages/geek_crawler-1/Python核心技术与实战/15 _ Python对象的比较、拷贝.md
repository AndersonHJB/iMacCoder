<audio title="15 _ Python对象的比较、拷贝" src="https://static001.geekbang.org/resource/audio/59/6f/59c1f81b6b6176ad81b4db3ea0213b6f.mp3" controls="controls"></audio> 
<p>你好，我是景霄。</p><p>在前面的学习中，我们其实已经接触到了很多  Python对象比较和复制的例子，比如下面这个，判断a和b是否相等的if语句：</p><pre><code>if a == b:
    ...
