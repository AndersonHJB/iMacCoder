...
</ul><p>通信结束后，我们还要像关闭文件一样，关闭socket。</p><h2>针对TCP应该如何编程？</h2><p>接下来我们来看，针对TCP，我们应该如何编程。</p><p><img src="https://static001.geekbang.org/resource/image/99/da/997e39e5574252ada22220e4b3646dda.png" alt=""></p><p>TCP的服务端要先监听一个端口，一般是先调用bind函数，给这个socket赋予一个端口和IP地址。</p><pre><code>int bind(int sockfd, const struct sockaddr *addr,socklen_t addrlen);
