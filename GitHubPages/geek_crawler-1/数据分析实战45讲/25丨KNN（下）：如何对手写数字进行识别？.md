<audio title="25丨KNN（下）：如何对手写数字进行识别？" src="https://static001.geekbang.org/resource/audio/bd/11/bd87b5d9179bfd3740fd19f6b7641b11.mp3" controls="controls"></audio> 
...
[[ 0.  0.  5. 13.  9.  1.  0.  0.]
 ...
 [ 0.  0.  6. 13. 10.  0.  0.  0.]]
0
</code></pre><p><img src="https://static001.geekbang.org/resource/image/62/3c/625b7e95a22c025efa545d7144ec5f3c.png" alt=""><br>
...
多项式朴素贝叶斯准确率: 0.8844
CART决策树准确率: 0.8556
</code></pre><p>这里需要注意的是，我们在做多项式朴素贝叶斯分类的时候，传入的数据不能有负数。因为Z-Score会将数值规范化为一个标准的正态分布，即均值为0，方差为1，数值会包含负数。因此我们需要采用Min-Max规范化，将数据规范化到[0,1]范围内。</p><p>好了，我们整理下这4个分类器的结果。</p><p><img src="https://static001.geekbang.org/resource/image/0f/e8/0f498e0197935bfe15d9b1209bad8fe8.png" alt=""><br>
