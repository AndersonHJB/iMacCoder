<audio title="40丨数据挖掘实战（2）：信用卡诈骗分析" src="https://static001.geekbang.org/resource/audio/8c/28/8c087cde91c03ca9bb6d1f23d7b65a28.mp3" controls="controls"></audio> 
<p>上一篇文章中，我们用随机森林以及之前讲过的SVM、决策树和KNN分类器对信用卡违约数据进行了分析，这节课我们来研究下信用卡欺诈。</p><p>相比于信用卡违约的比例，信用卡欺诈的比例更小，但是危害极大。如何通过以往的交易数据分析出每笔交易是否正常，是否存在盗刷风险是我们这次项目的目标。</p><p>通过今天的学习，你需要掌握以下几个方面：</p><ol>
<li>
