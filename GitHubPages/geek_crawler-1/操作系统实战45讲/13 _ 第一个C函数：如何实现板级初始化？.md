<audio title="13 _ 第一个C函数：如何实现板级初始化？" src="https://static001.geekbang.org/resource/audio/e0/85/e0744a7d4161a289fbc7197cbc7e9585.mp3" controls="controls"></audio> 
...
</code></pre><p>init_defgraph()函数初始了dftgraph_t结构体类型的变量kdftgh，我们在halglobal.c文件中定义这个变量，结构类型我们这样来定义。</p><pre><code>typedef struct s_DFTGRAPH
{
    u64_t gh_mode;         //图形模式
    u64_t gh_x;            //水平像素点
    u64_t gh_y;            //垂直像素点
